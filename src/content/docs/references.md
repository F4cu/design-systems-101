...
- zeroheight, *Design Systems Report 2026*
- [Figma / Design Executive Council, "The new business case for design systems"](https://www.figma.com/blog/the-new-business-case-for-design-systems/) — Freshworks, SAP, Hyundai Motor Group, Grammarly, Linear, Notion examples
...
- [Ness Grixti, "Wise Multi-Brand Design System — Case Study"](https://nessgrixti.com/portfolio/wise-multi-brand/) — also cited in [Governance case studies](/governance-case-studies/)
...
rather than inventing an answer. See [Start here](/) for the full framing.
