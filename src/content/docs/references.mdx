...
- [Workday Canvas Design System, "Compound Components"](https://github.com/Workday/canvas-kit/blob/master/modules/docs/mdx/COMPOUND_COMPONENTS.mdx), living doc: includes the configuration-vs-compound Tabs example
...
- [Supernova, "Getting Executive Buy-In and Proving ROI of Design Systems"](https://www.supernova.io/blog/getting-executive-buy-in-proving-roi-design-systems), 2024
...
- [Mike Fortuna, "How I Calculated the Business Case for a Design System"](https://medium.com/@m4tuna/how-i-calculated-the-business-case-for-a-design-system-549def283eb5), 2024
...
- [Ness Grixti, "Wise Multi-Brand Design System — Case Study"](https://nessgrixti.com/portfolio/wise-multi-brand/), n.d. — also cited in [Governance case studies](/governance-case-studies/)
...
- Murphy Trueman, `design-system-ops` — `knowledge-notes/ai-readiness.md`, `context-engine-blueprints.md`, `agent-orchestration-guide.md`, `human-oversight-framework.md`, `output-discipline.md`, `mcp-setup-guide.md`. Living doc.
