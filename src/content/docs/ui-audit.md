---
title: UI Audit & Heuristic Evaluation Before a Design System
---
...
- **Treating a heuristic finding as a verdict instead of a hypothesis.** A heuristic evaluation is an expert's judgment call against general principles, not evidence from real users — a flagged issue is worth checking against actual usage before it drives a redesign decision.
