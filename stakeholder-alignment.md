...
Running only the tactical horizon is what produces a system that's always fighting fires. Running only the normative horizon is what produces a system with a beautiful mission statement and no delivery. — Marianne Ashton-Booth, "From Silos to Systems," UXDX Berlin 2026
...
A pitch that can't complete that sentence usually has a gap in one of the 11 boxes, not just a communication problem. — Marianne Ashton-Booth, "From Silos to Systems," UXDX Berlin 2026 / [`marianneab.substack.com`](https://marianneab.substack.com), "LeanDS Framework"
